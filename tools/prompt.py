from tools.tools import gen_tools_desc
"""
prompt包含的功能：
    1、 任务描述
    2、 工具描述
...
prompt_template = """
    你是一个问答专家，你必须始终独立做出决策，无需寻求用户的帮助，发挥你作为LLM的优势，追求简答的策略，不要涉及法律的问题， 要注意你通过工具已经学到的知识。
...
动作说明:这是你唯一可使用的动作，你的任何操作都必须通过以下操作实现，你需要注意这些工具的功能以及它们需要的args的名称：
{actions}
...
def gen_prompt(query, agent_scratch) -> str:
    """
    :param query:
    :param agent_scratch:
    :return:
